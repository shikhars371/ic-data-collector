                ...
                children: <Widget>[
                  IconButton(
                      ...
                      onPressed: () async {
                        ...
                        await FileUpload().fileUpload(file: imagefile);
                      }),
                  Container(
...
//     fabItems = [
//       FabMiniMenu(
//           icon: Icons.cloud_upload, action: () => _uploadFile(_imageFile)),
//       FabMiniMenu(
//           //icon: Icons.image, action: () => _pickImage(ImageSource.gallery)),
//           icon: Icons.image,
//           action: () => _chooseFile()),
//       FabMiniMenu(
//           icon: Icons.camera, action: () => _pickImage(ImageSource.camera)),
//     ];
//   }
...
//         ['.jpg', 'jpeg', '.bmp', '.png'].contains(fileUtil.extension(
//             _imageFile.path))) // .contains(fileUtil.extension(_imageFile.path))
//     {
